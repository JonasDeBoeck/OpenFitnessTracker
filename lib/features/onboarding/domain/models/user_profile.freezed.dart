...
int get hashCode {
  final _this = this as UserProfile;
  return Object.hashAll([runtimeType,_this.id,_this.name,_this.sex,_this.age,_this.heightCm,_this.weightKg,_this.activityLevel,_this.goal,_this.bmr,_this.tdee,_this.targetCalories,_this.proteinGrams,_this.fatGrams,_this.carbGrams,_this.waterTargetMl,_this.customTargetCalories,_this.customProteinPerKg,_this.customFatPerKg,_this.customWaterTargetMl,_this.createdAt]);
}

@override
String toString() {
  final _this = this as UserProfile;
  return 'UserProfile(id: ${_this.id}, name: ${_this.name}, sex: ${_this.sex}, age: ${_this.age}, heightCm: ${_this.heightCm}, weightKg: ${_this.weightKg}, activityLevel: ${_this.activityLevel}, goal: ${_this.goal}, bmr: ${_this.bmr}, tdee: ${_this.tdee}, targetCalories: ${_this.targetCalories}, proteinGrams: ${_this.proteinGrams}, fatGrams: ${_this.fatGrams}, carbGrams: ${_this.carbGrams}, waterTargetMl: ${_this.waterTargetMl}, customTargetCalories: ${_this.customTargetCalories}, customProteinPerKg: ${_this.customProteinPerKg}, customFatPerKg: ${_this.customFatPerKg}, customWaterTargetMl: ${_this.customWaterTargetMl}, createdAt: ${_this.createdAt})';
}
...
as double,customTargetCalories: freezed == customTargetCalories ? _self.customTargetCalories : customTargetCalories // ignore: cast_nullable_to_non_nullable
as double?,customProteinPerKg: freezed == customProteinPerKg ? _self.customProteinPerKg : customProteinPerKg // ignore: cast_nullable_to_non_nullable
as double?,customFatPerKg: freezed == customFatPerKg ? _self.customFatPerKg : customFatPerKg // ignore: cast_nullable_to_non_nullable
as double?,customWaterTargetMl: freezed == customWaterTargetMl ? _self.customWaterTargetMl : customWaterTargetMl // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  String name,  Sex sex,  int age,  double heightCm,  double weightKg,  ActivityLevel activityLevel,  Goal goal,  double bmr,  double tdee,  double targetCalories,  double proteinGrams,  double fatGrams,  double carbGrams,  double waterTargetMl,  double? customTargetCalories,  double? customProteinPerKg,  double? customFatPerKg,  double? customWaterTargetMl,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserProfile() when $default != null:
return $default(_that.id,_that.name,_that.sex,_that.age,_that.heightCm,_that.weightKg,_that.activityLevel,_that.goal,_that.bmr,_that.tdee,_that.targetCalories,_that.proteinGrams,_that.fatGrams,_that.carbGrams,_that.waterTargetMl,_that.customTargetCalories,_that.customProteinPerKg,_that.customFatPerKg,_that.customWaterTargetMl,_that.createdAt);case _:
  return orElse();
...
class _UserProfile implements UserProfile {
  const _UserProfile({this.id, required this.name, required this.sex, required this.age, required this.heightCm, required this.weightKg, required this.activityLevel, required this.goal, required this.bmr, required this.tdee, required this.targetCalories, required this.proteinGrams, required this.fatGrams, required this.carbGrams, required this.waterTargetMl, this.customTargetCalories, this.customProteinPerKg, this.customFatPerKg, this.customWaterTargetMl, this.createdAt});
...
@override final  double? customTargetCalories;
@override final  double? customProteinPerKg;
@override final  double? customFatPerKg;
@override final  double? customWaterTargetMl;
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserProfile&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.sex, sex) || other.sex == sex)&&(identical(other.age, age) || other.age == age)&&(identical(other.heightCm, heightCm) || other.heightCm == heightCm)&&(identical(other.weightKg, weightKg) || other.weightKg == weightKg)&&(identical(other.activityLevel, activityLevel) || other.activityLevel == activityLevel)&&(identical(other.goal, goal) || other.goal == goal)&&(identical(other.bmr, bmr) || other.bmr == bmr)&&(identical(other.tdee, tdee) || other.tdee == tdee)&&(identical(other.targetCalories, targetCalories) || other.targetCalories == targetCalories)&&(identical(other.proteinGrams, proteinGrams) || other.proteinGrams == proteinGrams)&&(identical(other.fatGrams, fatGrams) || other.fatGrams == fatGrams)&&(identical(other.carbGrams, carbGrams) || other.carbGrams == carbGrams)&&(identical(other.waterTargetMl, waterTargetMl) || other.waterTargetMl == waterTargetMl)&&(identical(other.customTargetCalories, customTargetCalories) || other.customTargetCalories == customTargetCalories)&&(identical(other.customProteinPerKg, customProteinPerKg) || other.customProteinPerKg == customProteinPerKg)&&(identical(other.customFatPerKg, customFatPerKg) || other.customFatPerKg == customFatPerKg)&&(identical(other.customWaterTargetMl, customWaterTargetMl) || other.customWaterTargetMl == customWaterTargetMl)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,name,sex,age,heightCm,weightKg,activityLevel,goal,bmr,tdee,targetCalories,proteinGrams,fatGrams,carbGrams,waterTargetMl,customTargetCalories,customProteinPerKg,customFatPerKg,customWaterTargetMl,createdAt]);
}

@override
String toString() {
    return 'UserProfile(id: $id, name: $name, sex: $sex, age: $age, heightCm: $heightCm, weightKg: $weightKg, activityLevel: $activityLevel, goal: $goal, bmr: $bmr, tdee: $tdee, targetCalories: $targetCalories, proteinGrams: $proteinGrams, fatGrams: $fatGrams, carbGrams: $carbGrams, waterTargetMl: $waterTargetMl, customTargetCalories: $customTargetCalories, customProteinPerKg: $customProteinPerKg, customFatPerKg: $customFatPerKg, customWaterTargetMl: $customWaterTargetMl, createdAt: $createdAt)';
}
