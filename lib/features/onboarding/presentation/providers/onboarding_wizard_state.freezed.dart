...
mixin _$OnboardingWizardState {
 ...
 int get currentStep; String? get name; Sex? get sex; int? get age; double? get heightCm; double? get weightKg; ActivityLevel? get activityLevel; Goal? get goal; UserProfile? get result; bool get isSaving; String? get saveError;
...
int get hashCode {
  final _this = this as OnboardingWizardState;
  return Object.hash(runtimeType,_this.currentStep,_this.name,_this.sex,_this.age,_this.heightCm,_this.weightKg,_this.activityLevel,_this.goal,_this.result,_this.isSaving,_this.saveError);
}

@override
String toString() {
  final _this = this as OnboardingWizardState;
  return 'OnboardingWizardState(currentStep: ${_this.currentStep}, name: ${_this.name}, sex: ${_this.sex}, age: ${_this.age}, heightCm: ${_this.heightCm}, weightKg: ${_this.weightKg}, activityLevel: ${_this.activityLevel}, goal: ${_this.goal}, result: ${_this.result}, isSaving: ${_this.isSaving}, saveError: ${_this.saveError})';
}
...
@useResult
$Res call({
 int currentStep, String? name, Sex? sex, int? age, double? heightCm, double? weightKg, ActivityLevel? activityLevel, Goal? goal, UserProfile? result, bool isSaving, String? saveError
});
...
/// Create a copy of OnboardingWizardState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? currentStep = null,Object? name = freezed,Object? sex = freezed,Object? age = freezed,Object? heightCm = freezed,Object? weightKg = freezed,Object? activityLevel = freezed,Object? goal = freezed,Object? result = freezed,Object? isSaving = null,Object? saveError = freezed,}) {
...
as Goal?,result: freezed == result ? _self.result : result // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int currentStep,  String? name,  Sex? sex,  int? age,  double? heightCm,  double? weightKg,  ActivityLevel? activityLevel,  Goal? goal,  UserProfile? result,  bool isSaving,  String? saveError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OnboardingWizardState() when $default != null:
return $default(_that.currentStep,_that.name,_that.sex,_that.age,_that.heightCm,_that.weightKg,_that.activityLevel,_that.goal,_that.result,_that.isSaving,_that.saveError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int currentStep,  String? name,  Sex? sex,  int? age,  double? heightCm,  double? weightKg,  ActivityLevel? activityLevel,  Goal? goal,  UserProfile? result,  bool isSaving,  String? saveError)  $default,) {final _that = this;
switch (_that) {
case _OnboardingWizardState():
return $default(_that.currentStep,_that.name,_that.sex,_that.age,_that.heightCm,_that.weightKg,_that.activityLevel,_that.goal,_that.result,_that.isSaving,_that.saveError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int currentStep,  String? name,  Sex? sex,  int? age,  double? heightCm,  double? weightKg,  ActivityLevel? activityLevel,  Goal? goal,  UserProfile? result,  bool isSaving,  String? saveError)?  $default,) {final _that = this;
switch (_that) {
case _OnboardingWizardState() when $default != null:
return $default(_that.currentStep,_that.name,_that.sex,_that.age,_that.heightCm,_that.weightKg,_that.activityLevel,_that.goal,_that.result,_that.isSaving,_that.saveError);case _:
  return null;
...
class _OnboardingWizardState implements OnboardingWizardState {
  const _OnboardingWizardState({this.currentStep = 0, this.name, this.sex, this.age, this.heightCm, this.weightKg, this.activityLevel, this.goal, this.result, this.isSaving = false, this.saveError});
...
@override
int get hashCode {
    return Object.hash(runtimeType,currentStep,name,sex,age,heightCm,weightKg,activityLevel,goal,result,isSaving,saveError);
}

@override
String toString() {
    return 'OnboardingWizardState(currentStep: $currentStep, name: $name, sex: $sex, age: $age, heightCm: $heightCm, weightKg: $weightKg, activityLevel: $activityLevel, goal: $goal, result: $result, isSaving: $isSaving, saveError: $saveError)';
}
...
/// Create a copy of OnboardingWizardState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? currentStep = null,Object? name = freezed,Object? sex = freezed,Object? age = freezed,Object? heightCm = freezed,Object? weightKg = freezed,Object? activityLevel = freezed,Object? goal = freezed,Object? result = freezed,Object? isSaving = null,Object? saveError = freezed,}) {
