...
as double?,loggedUnitLabel: freezed == loggedUnitLabel ? _self.loggedUnitLabel : loggedUnitLabel // ignore: cast_nullable_to_non_nullable
as String?,loggedUnitCount: freezed == loggedUnitCount ? _self.loggedUnitCount : loggedUnitCount // ignore: cast_nullable_to_non_nullable
as double?,
  ));
}
...
switch (_that) {
case _DiaryEntry() when $default != null:
return $default(_that.id,_that.foodId,_that.foodName,_that.recipeId,_that.recipeName,_that.mealType,_that.loggedAt,_that.quantityGrams,_that.calories,_that.protein,_that.fat,_that.carbs,_that.fiber,_that.sugar,_that.sodiumMg,_that.cholesterolMg,_that.potassiumMg,_that.calciumMg,_that.ironMg,_that.vitaminCMg,_that.vitaminDMcg,_that.loggedUnitLabel,_that.loggedUnitCount);case _:
  return orElse();
...
@override final  String? loggedUnitLabel;
@override final  double? loggedUnitCount;
