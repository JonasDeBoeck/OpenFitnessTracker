...
@useResult
$Res call({
 int? id, int foodId, String foodName, MealType mealType, DateTime loggedAt, double quantityGrams, double calories, double protein, double fat, double carbs, double? fiber, double? sugar, double? sodiumMg, double? cholesterolMg, double? potassiumMg, double? calciumMg, double? ironMg, double? vitaminCMg, double? vitaminDMcg
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int foodId,  String foodName,  MealType mealType,  DateTime loggedAt,  double quantityGrams,  double calories,  double protein,  double fat,  double carbs,  double? fiber,  double? sugar,  double? sodiumMg,  double? cholesterolMg,  double? potassiumMg,  double? calciumMg,  double? ironMg,  double? vitaminCMg,  double? vitaminDMcg)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiaryEntry() when $default != null:
return $default(_that.id,_that.foodId,_that.foodName,_that.mealType,_that.loggedAt,_that.quantityGrams,_that.calories,_that.protein,_that.fat,_that.carbs,_that.fiber,_that.sugar,_that.sodiumMg,_that.cholesterolMg,_that.potassiumMg,_that.calciumMg,_that.ironMg,_that.vitaminCMg,_that.vitaminDMcg);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int foodId,  String foodName,  MealType mealType,  DateTime loggedAt,  double quantityGrams,  double calories,  double protein,  double fat,  double carbs,  double? fiber,  double? sugar,  double? sodiumMg,  double? cholesterolMg,  double? potassiumMg,  double? calciumMg,  double? ironMg,  double? vitaminCMg,  double? vitaminDMcg)  $default,) {final _that = this;
switch (_that) {
case _DiaryEntry():
return $default(_that.id,_that.foodId,_that.foodName,_that.mealType,_that.loggedAt,_that.quantityGrams,_that.calories,_that.protein,_that.fat,_that.carbs,_that.fiber,_that.sugar,_that.sodiumMg,_that.cholesterolMg,_that.potassiumMg,_that.calciumMg,_that.ironMg,_that.vitaminCMg,_that.vitaminDMcg);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int foodId,  String foodName,  MealType mealType,  DateTime loggedAt,  double quantityGrams,  double calories,  double protein,  double fat,  double carbs,  double? fiber,  double? sugar,  double? sodiumMg,  double? cholesterolMg,  double? potassiumMg,  double? calciumMg,  double? ironMg,  double? vitaminCMg,  double? vitaminDMcg)?  $default,) {final _that = this;
switch (_that) {
case _DiaryEntry() when $default != null:
return $default(_that.id,_that.foodId,_that.foodName,_that.mealType,_that.loggedAt,_that.quantityGrams,_that.calories,_that.protein,_that.fat,_that.carbs,_that.fiber,_that.sugar,_that.sodiumMg,_that.cholesterolMg,_that.potassiumMg,_that.calciumMg,_that.ironMg,_that.vitaminCMg,_that.vitaminDMcg);case _:
  return null;
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,foodId,foodName,mealType,loggedAt,quantityGrams,calories,protein,fat,carbs,fiber,sugar,sodiumMg,cholesterolMg,potassiumMg,calciumMg,ironMg,vitaminCMg,vitaminDMcg]);
}

@override
String toString() {
    return 'DiaryEntry(id: $id, foodId: $foodId, foodName: $foodName, mealType: $mealType, loggedAt: $loggedAt, quantityGrams: $quantityGrams, calories: $calories, protein: $protein, fat: $fat, carbs: $carbs, fiber: $fiber, sugar: $sugar, sodiumMg: $sodiumMg, cholesterolMg: $cholesterolMg, potassiumMg: $potassiumMg, calciumMg: $calciumMg, ironMg: $ironMg, vitaminCMg: $vitaminCMg, vitaminDMcg: $vitaminDMcg)';
}
